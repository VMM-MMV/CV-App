...
function Languages({ onDataCollected }) {
                            ...
                            <div className="form5">
                                <div className="language-full-fields">
                                    <div className="language-field">
                                        ...
                                        <input type="text" placeholder="e.g English" className="form-name" autoComplete="language" value={language} onChange={e => setLanguage(e.target.value)}/>
                                    </div>
